...
int main()
{
    ...
    float **data_raw = read2d_sample(fname, width, height, imgw, imgh);
    std::cout << width << " " << height << std::endl;
    std::cout << imgw << " " << imgh << std::endl;
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "draw2d", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader ourShader("./draw2d.vs", "./draw2d.fs");
